...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-17 00:26`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/776b1edb-58a5-4107-a90b-c247a78c642a.git
$ cd 776b1edb-58a5-4107-a90b-c247a78c642a
```
